...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About OfferSendly" },
      { name: "description", content: "How OfferSendly evaluates offers and what makes our editorial approach different." },
    ],
  }),
  component: AboutPage,
});
  ...
  return (
    <GlobalLayout>
      <article className="max-w-3xl mx-auto px-6 py-20">
        <h1>About OfferSendly</h1>
        <p className="mt-6 text-[18px] text-[var(--text-secondary)] leading-relaxed">
          OfferSendly is a small editorial team that reviews digital products and consumer offers
        ...
        <p className="mt-4 text-[var(--text-secondary)]">
          ...
          performance research. We've spent years in adjacent industries and started OfferSendly
        ...
        <p className="mt-4 text-[var(--text-secondary)]">
          OfferSendly earns a commission when you purchase through a link on this site. This
